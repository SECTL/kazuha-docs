...
export default defineConfig({
  lang: 'zh-CN',
  title: '荧素万演文档',
  titleTemplate: (title) => title ? `${title} - 荧素万演文档` : '荧素万演文档',
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: '快速上手', link: '/quick-start/', activeMatch: '^/quick-start/', icon: 'book' },
      { text: '应用帮助', link: '/app-help/', activeMatch: '^/app-help/', icon: 'help-circle' },
      { text: '开发', link: '/develop/', activeMatch: '^/develop/', icon: 'code' },
      { text: '社区', link: '/community/', icon: 'message-circle' },
    ],
    ...
    sidebar: [
      {
        ...
        collapsed: false,
        items: [
          { text: '快速上手', link: '/quick-start/', icon: 'book-open' },
          { text: '下载与安装', link: '/quick-start/install', icon: 'download' },
          { text: '概念性导向', link: '/quick-start/concepts', icon: 'compass' },
          { text: '结束', link: '/quick-start/finish', icon: 'check-circle' },
        ]
      },
      {
        text: '应用帮助',
        ...
        collapsed: false,
        items: [
          { text: '主界面', link: '/app-help/main-interface', icon: 'layout' },
          { text: '常规设置', link: '/app-help/general-settings', icon: 'settings' },
          { text: '工具栏', link: '/app-help/toolbar', icon: 'tool' },
          {
            text: '个性化',
            icon: 'palette',
            collapsed: false,
            items: [
              { text: '配色方案', link: '/app-help/palette', icon: 'droplet' },
              { text: 'Overlay 主题', link: '/app-help/overlay-theme', icon: 'layers' },
              { text: '启动画面', link: '/app-help/splash-screen', icon: 'monitor' }
            ]
          },
          { text: '窗口设置', link: '/app-help/window-settings', icon: 'maximize' },
          {
            text: '存储与备份',
            icon: 'database',
            collapsed: false,
            items: [
              { text: '存储', link: '/app-help/storage', icon: 'server' },
              { text: '档案', link: '/app-help/archive', icon: 'archive' },
              { text: '备份', link: '/app-help/backup', icon: 'save' }
            ]
          },
          { text: '通知设置', link: '/app-help/notifications', icon: 'bell' },
          {
            text: '内建功能',
            icon: 'star',
            collapsed: false,
            items: [
              { text: '小黑板', link: '/app-help/blackboard', icon: 'edit-2' },
              { text: '计时器', link: '/app-help/timer', icon: 'clock' },
              { text: '聚光灯', link: '/app-help/spotlight', icon: 'sun' }
            ]
          }
        ]
      },
    ...
    editLink: {
      pattern: 'https://github.com/Haraguse/kazuha-documents/edit/main/src/:path',
  ...
  markdown: {
    config: (md) => {
      // Use VitePress native markdown rendering without custom metadata injection.
    },
    image: {
      // 开启图片懒加载
      lazyLoading: true
