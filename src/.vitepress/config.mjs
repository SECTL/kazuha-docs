...
export default defineConfig({
  ...
  sitemap: {
    hostname: 'https://luminalium.sectl.top',
  },
  themeConfig: {
    logo: '/logo.svg',
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '<span class="iconify" data-icon="material-symbols:timer-rounded"></span> 计时器', link: '/features/timer' },
          { text: '<span class="iconify" data-icon="iconoir:square-cursor"></span> 聚光灯', link: '/features/spotlight' },
          { text: '<span class="iconify" data-icon="fluent:apps-48-regular"></span> 应用启动器', link: '/features/app-launcher' },
          { text: '<span class="iconify" data-icon="fluent:drawer-24-regular"></span> 板中板', link: '/features/board' },
          { text: '<span class="iconify" data-icon="fluent:status-24-regular"></span> 状态栏', link: '/features/status-bar' }
        ]
      },
      {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/SECTL/Luminalium' },
      {
        icon: {
      ...
      },
      {
        ...
        link: 'https://forum.smart-teach.cn/t/luminalium'
      },
    ],
    ...
    editLink: {
      pattern: 'https://github.com/SECTL/Luminalium-docs/edit/main/src/:path',
